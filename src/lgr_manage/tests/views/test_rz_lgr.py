...
class TestRzLgrCreateView(LgrWebClientTestBase):
    model = RzLgr
    base_url = '/m/rz-lgr'
    ...
    def get_create_body():
        return {
            ...
            'repository': [
                SimpleUploadedFile('rz-lgr-1.xml', MIN_LGR, content_type='text/xml'),
...
class TestRzLgrDeleteView(LgrWebClientTestBase):
    model = RzLgr
    base_url = '/m/rz-lgr'
    ...
    def test_delete_when_logged_in_as_admin(self):
        ...
        self.assertFalse(RzLgrMember.objects.filter(common=self.other_instance.pk).exists())
...
class TestRzLgrUpdateView(LgrWebClientTestBase):
    model = RzLgr
    base_url = '/m/rz-lgr'
...
class TestRzLgrAccessView(LgrWebClientTestBase):
    model = RzLgr
    base_url = '/m/rz-lgr'
