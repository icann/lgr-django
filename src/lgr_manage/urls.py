...
urlpatterns = [
    ...
    path('rz-lgr/<int:lgr_id>/delete', RzLgrDeleteView.as_view(), name='lgr_admin_delete_rz_lgr'),
    path('rz-lgr/<int:lgr_id>', DisplayRzLgrView.as_view(), name='lgr_admin_display_rz_lgr'),
    ...
    path('ref-lgr/<int:lgr_id>/delete', RefLgrDeleteView.as_view(), name='lgr_admin_delete_ref_lgr'),
    path('ref-lgr/<int:lgr_id>', DisplayRefLgrView.as_view(), name='lgr_admin_display_ref_lgr'),
    path('users', LgrUserView.as_view(), name='lgr_admin_user_management'),
    path('users/<int:user_id>/delete', LgrUserDeleteView.as_view(), name='lgr_admin_delete_user'),
]
