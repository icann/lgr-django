...
from lgr_manage.views.reference_lgr import RefLgrView, RefLgrDeleteView, RefLgrIsActiveView, RefLgrMemberUpdateView
...
urlpatterns = [
    ...
    path('ref-lgr/<int:lgr_pk>/update', RefLgrMemberUpdateView.as_view(), name='lgr_admin_update_ref_lgr'),
