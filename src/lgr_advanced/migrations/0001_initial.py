# Generated by Django 3.1.7 on 2021-08-30 19:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(blank=True, limit_choices_to=models.Q(models.Q(('app_label', 'lgr_advanced'), ('model', 'LgrModel')), models.Q(('app_label', 'lgr_models'), ('model', 'RzLgr')), _connector='OR'), null=True, on_delete=django.db.models.deletion.SET_NULL, to='contenttypes.contenttype')),
