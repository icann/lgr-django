...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('lgrMariaDB'),
        'USER': os.environ.get('lgrMariaUser'),
        'PASSWORD': os.environ.get('lgrMariaPwd'),
        'HOST': os.environ.get('lgrMariaHost'),
        'PORT': os.environ.get('lgrMariaPort'),
    }
}
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://' + os.environ.get('lgrRedisHost') + ':' + os.environ.get('lgrRedisPort') + '/1',
    }
}

BROKER_URL = 'redis://' + os.environ.get('lgrRedisHost') + ':' + os.environ.get('lgrRedisPort') + '/0'
